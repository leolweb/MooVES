 ...
 * @version: 1.0
 * @requirements: MooTools 1.3+ Core [Element.Event, Element.Style, DomReady, Swiff, Fx.Morph, Request]
 *
 ...
 *
 * Current MooTools version: 1.3 stable <http://www.mootools.net/>
 *
...
var MooVES = new Class({
  ...
  initialize: function(item, options){
    this.setOptions(options);
		...
		if(this.options.container != undefined) this.url = this.item.getElement(this.options.container).get(this.options.parse);
		...
		if(this.url != undefined){
			...
			if(this.data != undefined) this.build(this.data);
		}
	},
	...
	html5_video: function(data, ext){
		switch(data.html5_method){
			case 'native':
				if(typeOf(data.html5_src)=='object') var source = Object.subset(data.html5_src, [ext[0]]);
				else var source = data.html5_src;
				var video = new Element('video', {
					id: 'mooves_video_' + String.uniqueID(),
				...
				if(typeOf(data.html5_src)=='object'){
					Object.each(data.html5_src, function(source){
...
MooVES = new Class({
  ...
  provider: function(){
    ...
    Object.append(this, DailyMotion());
    return this;
  },
...
MooVES = new Class({
  ...
  provider: function(){
    ...
    Object.append(this, GoogleVideo());
    return this;
  },
